# 🏥 EHR Hub: Sistema de Historia Clínica Distribuida e Interoperable (HL7 FHIR)
...
├── database/                  # SQL Scripts para inicialización de nodos
├── docs/                      # Archivos de requerimientos y manuales
├── scripts/                   # Utilidades en Python y SH para pruebas
